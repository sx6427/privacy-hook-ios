//
// PrivacyHook.m — v16: PURE Step33 (payment-proven, no extras)
//
// ONLY: Bundle ID hook + Keychain clear + IDFA/IDFV + device name
// NO cookie hooks, NO jailbreak bypass, NO fishhook, NO NSProcessInfo
//
// Purpose: isolate whether "下单人数过多" is caused by Cookie hooks
// If this works → Cookie hook is the problem
// If this fails → something else changed since Step33
//
...
static void initPrivacyHook(void) {
    @autoreleasepool {
        ...
        // NO jailbreak bypass
        // NO fishhook
        // NO NSProcessInfo hook
        // NO NSFileManager hook
    }
}
