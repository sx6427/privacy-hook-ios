"""Push v5 PrivacyHook.m + Makefile + build.yml to GitHub."""
...
msg = "v5: anti-detection (dyld hiding, dladdr hiding, NSLog silenced, dylib renamed)"

print("Updating PrivacyHook.m...")
with open("PrivacyHook.m", "rb") as f:
    update_file("PrivacyHook.m", f.read(), msg)

print("Updating Makefile...")
with open("Makefile", "rb") as f:
    update_file("Makefile", f.read(), msg)

print("Updating build.yml...")
with open(".github/workflows/build.yml", "rb") as f:
    update_file(".github/workflows/build.yml", f.read(), msg)
